...
faces, labels = prepare_training_data("/Users/tanay/training-data")
print("Data prepared")
...
def predict(test_img):
    ...
    label, faces = face_recognizer.predict(face)
...
#load test images
test_img1 = cv2.imread("/Users/tanay/test-data/test1.jpg")
test_img2 = cv2.imread("/Users/tanay/test-data/test2.jpg")
